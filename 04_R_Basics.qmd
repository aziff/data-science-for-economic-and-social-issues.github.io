...
Recall from [chapter 3](#chapter1) that the documentation for functions is readily available from the command line. Online searches can help bolster this information with troubleshooting and examples.
