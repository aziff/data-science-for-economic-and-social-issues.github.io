...
There are many options to alter the output. Here are a few examples. See `?stargazer` and [this document](https://cran.r-project.org/web/packages/stargazer/vignettes/stargazer.pdf) for more examples. Remember to change the type to `html` if you are compiling the below to HTML.
...
## Advanced: Creating Tables from Scratch
...
Reference the [dplyr cheat sheet](https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf). Higher-order moments are available in the `moments` package.
